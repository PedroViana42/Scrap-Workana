...
def create_default_registry() -> CollectorRegistry:
    ...
    from radar.collectors.jobs.smartrecruiters import SmartRecruitersCollector
    ...
    registry.register(SmartRecruitersCollector.source_name, SmartRecruitersCollector)
